...
import { Send, Server, Clock, AlertCircle, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full w-full gap-2">
      ...
      `}>
         ...
         <Button 
            onClick={sendRequest} 
            disabled={!isReady || isLoading || !serverReady}
      ...
      >
        <div className="flex flex-col h-full relative">
            ...
            {/* We keep the iframe visible but small at the bottom for console logs */}
