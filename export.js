    ...
    "aside",
    {
      ...
      `, children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react4.BookOpen, { className: `w-4 h-4 ${themeMode === "dark" ? "text-blue-400" : "text-blue-600"}` }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h2", { className: "font-semibold text-sm", children: "Documentation" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Button, { variant: "ghost", onClick: onClose, className: "!p-1 h-8 w-8", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_lucide_react4.X, { className: "w-4 h-4" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex-1 overflow-y-auto p-4 space-y-6", children: docs ? docs.map((section, idx) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "space-y-3", children: section.items.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: `
                    p-3 rounded-md text-sm
                    ${themeMode === "dark" ? "bg-black/20 hover:bg-black/40" : "bg-white shadow-sm border border-gray-100"}
                  `, children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("code", { className: `
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: `
                    ...
                    `, children: item.desc }),
            item.example && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `
        ...
        ] }, idx)) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "text-center py-8 opacity-60 text-sm", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { children: "No documentation available for this mode." }) }) })
      ]
    }
  );
};
